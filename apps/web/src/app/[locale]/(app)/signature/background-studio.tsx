  ...
  return (
    <div className="mt-6">
      <div className="flex flex-wrap items-end gap-4">
        ...
        <label className="text-sm">
          <span className="mb-1 block text-muted">{labels.scheme}</span>
          <select
            value={scheme}
      ...
      {svg ? (
        <div className="mt-6">
          ...
          <button
            ...
            className="mt-3 rounded-lg bg-surface-2 px-3 py-1.5 text-xs font-medium hover:bg-surface-3"
          >
            {labels.download}
          </button>

          <p className="mt-2 text-xs text-faint">{labels.hint}</p>
        </div>
      ) : null}
    </div>
  );
