    ...
    <div className="mt-4">
      <form action={create} className="grid gap-3 sm:grid-cols-2">
        ...
        <label className="text-sm sm:col-span-2">
          <span className="mb-1 block text-muted">{labels.cards}</span>
          <select
            name="cardIds"
            multiple
          ...
          <span className="mt-1 block text-xs text-faint">{labels.cardsHint}</span>
        </label>
        ...
        <div className="sm:col-span-2">
          <p className="text-sm text-muted">{labels.qualifiers}</p>
          <p className="mt-0.5 text-xs text-faint">{labels.qualifiersHint}</p>
          ...
          <button
            ...
            className="mt-2 rounded-lg bg-surface-2 px-2.5 py-1 text-xs font-medium hover:bg-surface-3"
          >
            {labels.addQualifier}
          </button>
        </div>
