  ...
  return (
    <div className="mt-4 rounded-xl border border-neutral-200 p-5 dark:border-neutral-800">
      <p className="text-sm text-neutral-600 dark:text-neutral-400">
        {labels.renewsOn}: {new Date(subscription.currentPeriodEnd).toLocaleDateString(locale)}
      </p>
      ...
      {subscription.cancelAtPeriodEnd ? (
        <button
          ...
          onClick={resume}
          disabled={pending}
          className="mt-4 rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white disabled:opacity-50"
        >
